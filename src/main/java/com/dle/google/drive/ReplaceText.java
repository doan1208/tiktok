...
//        {
            ...
            try
            {
                document = Loader.loadPDF( new File("/Users/dle/Downloads/202311281608327F5F1D8B74F7251AFC51_1701187713512199465.pdf") );
...
//                System.out.println("S, Đen" + " => "+ "S, Đen -> S, Xam");
//
//                document = _ReplaceText(document, "S, Đen", "S, Đen -> S, Xam");
//                document.save( "/Users/dle/Downloads/temp14.pdf" );
            }
            finally
            {
                if( document != null )
